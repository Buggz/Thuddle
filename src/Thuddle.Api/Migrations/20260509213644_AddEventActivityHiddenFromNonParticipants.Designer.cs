...
namespace Thuddle.Api.Migrations
{
    ...
    [Migration("20260509213644_AddEventActivityHiddenFromNonParticipants")]
    partial class AddEventActivityHiddenFromNonParticipants
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Thuddle.Api.Data.EventActivity", b =>
                {
                    ...
                    b.Property<bool>("HiddenFromNonParticipants")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Thuddle.Api.Data.EventActivityWaitlistEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime>("JoinedWaitlistAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("EventActivityWaitlistEntries");
                });
            ...
            modelBuilder.Entity("Thuddle.Api.Data.EventBlocklistEntry", b =>
                {
                    b.Property<Guid>("EventId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Thuddle.Api.Data.Raffle", b =>
                {
                    ...
                    b.Property<bool>("SelfReportingEnabled")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Thuddle.Api.Data.RaffleDraw", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("TicketsAfter")
                        .HasColumnType("integer");

                    b.Property<int>("TicketsBefore")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Thuddle.Api.Data.RaffleEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Thuddle.Api.Data.EventBlocklistEntry", b =>
                {
                    b.HasOne("Thuddle.Api.Data.User", "BlockedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Thuddle.Api.Data.RaffleDraw", b =>
                {
                    b.HasOne("Thuddle.Api.Data.Raffle", "Raffle")
                        .WithMany("Draws")
